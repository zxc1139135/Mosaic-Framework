...
supporting multiple datasets and granularity levels.
"""
...
class TextDataset(Dataset):
 ...
 max_length: 
 granularity: 
 vocab_size: （fallback tokenization）
 """
 self.texts = texts
...
class HuggingFaceDataLoader:
 ...
 Args:
 subset_name: ( "ArXiv", "PubMed", "Wikipedia")
 max_samples: 
