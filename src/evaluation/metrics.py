...
Implements evaluation metrics for membership inference attacks.
"""
...
class MembershipInferenceEvaluator:
 ...
 : max(TPR - FPR) over all thresholds
...
if __name__ == "__main__":
 ...
 improvements = comparator.compute_improvement("Mosaic", "Random")
