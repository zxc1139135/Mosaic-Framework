...
Joint training of router network and meta-learner components.
"""
...
class RouterLoss(nn.Module):
 ...
 : L_routing = L_task + λ_balance * L_balance + λ_explore * L_explore
...
class MetaLearnerLoss(nn.Module):
 ...
 : L_meta = -E[y log p + (1-y) log(1-p)] + λ_reg ||θ_meta||²
...
if __name__ == "__main__":
 ...
 input_dim=num_experts * 3 + num_experts + 64, # 
 hidden_dims=[64, 32],
 )
